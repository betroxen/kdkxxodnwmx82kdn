  ...
  return (
    <div className="container mx-auto max-w-5xl animate-fadeIn">
        ...
        <div className="bg-foundation-light rounded-xl border border-[#333] shadow-2xl overflow-hidden p-2 md:p-4">
            {/* FIX: Accordion components were not nested correctly. Corrected the structure to properly wrap children within Accordion, AccordionItem, AccordionTrigger, and AccordionContent. */}
