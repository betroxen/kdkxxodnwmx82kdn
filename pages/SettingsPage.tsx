    ...
    return (
        <div className="min-h-screen bg-foundation p-4 sm:p-8 font-rajdhani animate-fadeIn">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {/* FIX: The ConsoleModule component expects children, but was being used as a self-closing tag. The content for the module is now correctly passed as children. */}
