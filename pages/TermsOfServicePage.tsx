...
const termsSections = [
    { id: 'agreement', title: '1. DEFINITIONS & AGREEMENT' },
    { id: 'eligibility', title: '2. ELIGIBILITY & ACCEPTANCE' },
    { id: 'services', title: '3. THE ZAPWAY EDGE (SERVICES & TECHNOLOGY)' },
    { id: 'risk', title: '4. TECHNICAL ACKNOWLEDGMENT & RISK' },
    { id: 'conduct', title: '5. PROHIBITED CONDUCT & ACCOUNT INTEGRITY' },
    { id: 'financial-risk', title: '6. FINANCIAL RISK & VOLATILITY' },
    { id: 'ip', title: '7. INTELLECTUAL PROPERTY' },
    { id: 'rg-xai', title: '8. RESPONSIBLE GAMING & XAI CONSENT' },
    { id: 'liability', title: '9. LIMITATION OF LIABILITY' },
    { id: 'indemnification', title: '10. INDEMNIFICATION' },
    { id: 'governing-law', title: '11. GOVERNING LAW & DISPUTE RESOLUTION' },
    { id: 'changes', title: '12. CHANGES TO THE TERMS OF SERVICE' },
];

// Helper component for the TOC link list
const TermsTOC: React.FC<{ activeId: string }> = ({ activeId }) => (
        ...
        <div className="min-h-screen bg-foundation p-4 md:p-8">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="md:col-span-1 hidden md:block sticky top-8 h-fit animate-fadeIn">
                    <TermsTOC activeId={activeSection} />
                </div>
                ...
                <div className="md:col-span-3 animate-fadeIn text-text-secondary space-y-10">
                    ...
                    <div className="mt-12 space-y-8 text-sm leading-relaxed">
                        ...
                        <section id="agreement" className="pt-4">
                        ...
                        <section id="eligibility" className="pt-4">
                        ...
                        <section id="risk" className="pt-4">
                        ...
                        <section id="conduct" className="pt-4">
                            ...
                            <p className="mt-2 font-bold text-warning-low p-2 bg-foundation-light rounded-md border border-warning-low/30">Consequence: Any violation of this Section will result in the immediate and permanent termination of your account, forfeiture of all associated funds, and reporting to relevant legal and regulatory authorities.</p>
                        </section>

                        <section id="financial-risk" className="pt-4">
                        ...
                        <section id="rg-xai" className="pt-4">
                        ...
                        <section id="liability" className="pt-4">
                            ...
                            <p className="uppercase text-warning-low/90 font-bold p-3 bg-foundation-lighter rounded-md border border-warning-low/30">TO THE MAXIMUM EXTENT PERMITTED BY LAW, ZAPWAY, ITS OFFICERS, DIRECTORS, AND EMPLOYEES, SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, EXEMPLARY, PUNITIVE, OR CONSEQUENTIAL DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES, ARISING OUT OF OR IN CONNECTION WITH YOUR USE OR INABILITY TO USE THE SERVICES, INCLUDING, WITHOUT LIMITATION, LOSSES DUE TO: SMART CONTRACT FAILURE, VRF MALFUNCTION, HACKING, OR DIGITAL ASSET MARKET VOLATILITY.</p>
                        </section>

                        <section id="indemnification" className="pt-4">
                        ...
                        <section id="governing-law" className="pt-4">
